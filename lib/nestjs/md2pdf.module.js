...
class Md2PdfModule {
  /**
   * Synchronous registration with default options
  ...
  /**
   * Async registration with factory function
   * @param {Object} options - Configuration options
   * @param {Function} options.useFactory - Factory function to create options
   * @param {Array} options.inject - Dependencies to inject
   * @returns {Object} Module configuration
   */
